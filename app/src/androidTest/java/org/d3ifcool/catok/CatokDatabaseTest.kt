...
//        val historiTransaksi = HistoriTransaksiEntity(id_histori = 1L, total = 2000.0, produk = "-Tahu Isi.", jumlahProdukDibeli = 1, invoice = "CTK123", bayar = 3000.0, kembalian = 1000.0, catatan = "", pembayaran = "CASH", statusBayar = "LUNAS", tanggal = getCurrentDate(), diskon = 0.0)
